/* =======================SET======================= */
const nameBand = "TYLER BATES";

let nameSongs = [
	"JOHN WICK RECKONING", /*1*/
	"LA VENDETTA", /*2*/
	"VENDETTA + KILLING STRANGERS", /*3*/
	"MAN OF FOCUS", /*4*/
	"SUITS MAPS AND GUNS", /*5*/
	"SANTINO", /*6*/
	"PEACE & VODKA", /*7*/
	"CATACOMBS", /*8*/
	"MIRROR MAYHEM", /*9*/
	"BE SEEING YOU", /*10*/
	"TEN PACES", /*11*/
	"PISTOL PROCESSION", /*12*/
	"CHESS CLUB", /*13*/
	"HELEN A HANDBASKET", /*14*/
	"A GRAVE ACCUSATION", /*15*/
	"THE EX EX", /*16*/
	"GLASS HOUSE FIGHT", /*17*/
	"ZERO VS WICK", /*18*/
	"ELDER TENT OFFERING", /*19*/
	"TAXI RIDE", /*20*/
]
